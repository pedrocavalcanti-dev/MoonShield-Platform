import { fetchJSON, unwrapPayload, apiUrl, sanitizeUrl, handleError } from '../nucleo/api.js';
import { state, TASK_LABELS, TASK_ICONS } from '../nucleo/estado.js';
import { safeArray, readPath, numberValue, textValue, capitalize, escapeHTML, formatDate, formatDuration } from '../nucleo/utilitarios.js';
